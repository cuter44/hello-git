...
<a id="finish-install"></a>到这里就装完了, 首次起动之前, 你需要和FTS.或galin联系为你建个新的帐号. 如果你熟悉SSH和Bash的话也可以自己来:
...
还有我想吐槽的是由于坑货FTS.的缘故, 本来我们还可以架个私有的[GitHub](https://github.com)(好处是集成了代码直接下载/即时代码吐槽/错误追踪/wiki等有用功能), 但是现在没有, 我-很-不-开-心(本章完)  
